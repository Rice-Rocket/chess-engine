...
impl<'a> Evaluation<'a> {
    #[evaluation_fn]
    pub fn isolated(&self) -> BitBoard {
        todo!();
    }

    #[evaluation_fn]
    pub fn opposed(&self) -> BitBoard {
        todo!();
    }

    #[evaluation_fn]
    pub fn phalanx(&self) -> BitBoard {
        todo!();
    }

    #[evaluation_fn]
    pub fn supported(&self) -> BitBoard {
        todo!();
    }
    ...
    #[evaluation_fn]
    pub fn doubled(&self) -> BitBoard {
        todo!();
    }

    #[evaluation_fn]
    pub fn connected(&self) -> BitBoard {
        todo!();
    }
    ...
    #[evaluation_fn]
    pub fn weak_unopposed_pawn(&self) -> BitBoard {
        todo!();
    }

    #[evaluation_fn]
    pub fn weak_lever(&self) -> BitBoard {
        todo!();
    }
    ...
    #[evaluation_fn]
    pub fn doubled_isolated(&self) -> BitBoard {
        todo!();
    }
...
mod tests {
    ...
    #[evaluation_test("1r3q1R/p3n2n/np1k1pR1/pQ3P1B/1b1P1qpr/QP3n1P/P2P1P2/2B1N1RK w kq - 9 6")]
    fn test_backward() {
        assert_eval!(+ - friendly_backward, 2, 1, eval);
    }
