use bevy::prelude::*;
use crate::{board::{moves::Move, board::Board, zobrist::Zobrist}, move_gen::{move_generator::MoveGenerator, precomp_move_data::PrecomputedMoveData, bitboard::utils::BitBoardUtils, magics::MagicBitBoards}, ai::{ai_player::{BeginSearch, SearchComplete}, stats::SearchStatistics}};
...
impl SearcherV1 {
    ...
    pub fn start_search(&mut self,
        ...
        // println!("{}", board.white_to_move);
        // ! AI IS CONFUSED ON WHOSE TURN IT IS
        // ! IF ODD NUMBER SEARCH DEPTH AI PLAYS THE CORRECT TEAM
    ...
    fn search(
        ...
        if current_depth != 0 { move_gen.generate_moves(board, precomp, bbutils, magic, false) };
